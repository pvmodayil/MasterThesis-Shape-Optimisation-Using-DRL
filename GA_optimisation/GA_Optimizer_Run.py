...
# main function
#--------------------------------------------------------------------------------------
def optimizer(a,b,c,d,N,V0,eps_r1,eps_r2,df_rlPred,df_nom,population_size,evolution_steps,results_folder,case):
    # Make Result folder
    #-----------------------------------
    ...
    #---------------------------------------------
    init_imgfile = results_folder+f'/GA_Init_GPts_{case}.png'
    plot_initial_curve(x_i,df_rlPred,df_nom,upper,x_threshold,y_threshold,init_imgfile)
